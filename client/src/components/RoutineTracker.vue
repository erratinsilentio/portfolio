...
<template>
    <section class="info">
        <section class="left">
            <a href="https://routine-tracker-xi.vercel.app" target="_blank" class="a-screen">
                <img src="../assets/routinetracker.png" alt="project" class="screen" @mouseover="toggleRedir(true)"
